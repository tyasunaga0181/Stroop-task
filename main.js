...
var finish = {
 ...
 stimulus:"以上で質問紙は終了です。" +
          "いずれかのキーを押すと画面上に本実験のデータが表示されますので"+
          "そのデータを<b>すべてコピーし実験募集のメールに記載された連絡先にすべて貼り付けて送ってください。<b>"+
          "その連絡をもって実験に参加していただいたことを確認するため、"+
  　　　　 "<b>連絡がなかった場合参加点を付与することができませんので必ずメールを送っていただきますようよろしくお願いします。<b>"+
          "メールの送信をもって実験終了となりますので、メールを送信された方はウィンドウを閉じていただいて構いません、"+
          "本日は実験に参加していただきありがとうございました。"
         };
